...
from data_converter import nuscenes_converter_infra as nuscenes_converter
...
def main():
    ...
    parser.add_argument("--dataset", metavar="kitti", default='nuscenes', help="name of the dataset")
    parser.add_argument(
        "--root-path",
        type=str,
        #default="/home/jmeng18/bev_fusion/bevfusion-beliv/V2X-SIM",
        default='/scratch/jmeng18/V2X-SIM',
