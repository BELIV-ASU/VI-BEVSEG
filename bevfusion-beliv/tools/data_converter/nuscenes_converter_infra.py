...
def get_available_scenes(nusc):
    ...
    for scene in nusc.scene:
        ...
        sd_rec = nusc.get('sample_data', sample_rec['data']['LIDAR_TOP_id_1'])
...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmcv.track_iter_progress(nusc.sample):
        ...
        camera_types = [
            ...
            'SEG_FRONT_id_1',
            'SEG_FRONT_LEFT_id_1',
            'SEG_FRONT_RIGHT_id_1',
            'SEG_id_0_0',
            'SEG_id_0_1',
            'SEG_id_0_2',
            'SEG_id_0_3',
        ]  ## Add infrastructure camera
        ...
        if not test:
            ...
            info['num_radar_pts'] = np.array([0 for a in annotations])
